...
# FREEZE PREVENTION: Reduced timeouts and attempts
MAX_CONNECTION_ATTEMPTS = 3  # Reduced from 5 to prevent long blocking
MAX_CONSECUTIVE_FAILURES = 5  # Reduced from 10  
DEFAULT_TIMEOUT_SECONDS = 5   # Reduced from 10
MAX_SYMBOL_TEST_ATTEMPTS = 2  # Reduced from 3
CONNECTION_RETRY_DELAY = 1    # Reduced from 3 seconds
